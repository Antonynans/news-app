...
LOGIN_REDIRECT_URL = 'home'  # the login and logout redirect url tells
LOGOUT_REDIRECT_URL = 'home'    # django to send the user back to the home page
...
EMAIL_HOST_USER = 'f7d0b107-370d76e0'
EMAIL_HOST_PASSWORD = '191295cd0b67efb15b345beb686812f2-f7d0b107-763bf44d'
EMAIL_PORT = '587'
EMAIL_USE_TLS = True
